...
class TestSignUpForm(TransactionTestCase):
    ...
    def test_sigh_up_form_validate(self):
        form_valid = SignUpForm(data={
            'first_name': 'Garry',
            'last_name': 'Galler',
        ...
        form_invalid_name_too_long = SignUpForm(data={
            'first_name': 'Garry' * 31,
            'last_name': 'Galler',
            'username': 'garry_galler',
            'password1': 'secretpassword',
        ...
        form_invalid_name_is_empty = SignUpForm(data={
            'first_name': '',
            'last_name': 'Galler',
            'username': 'garry_galler',
            'password1': 'secretpassword',
        ...
        form_invalid_last_name_too_long = SignUpForm(data={
            'first_name': 'Garry',
            'last_name': 'Galler' * 31,
            'username': 'garry_galler',
            'password1': 'secretpassword',
        ...
        form_invalid_last_name_is_empty = SignUpForm(data={
            'first_name': 'Garry',
            'last_name': '',
            'username': 'garry_galler',
            'password1': 'secretpassword',
        ...
        form_invalid_username_too_long = SignUpForm(data={
            'first_name': 'Garry',
            'last_name': 'Galler',
        ...
        form_invalid_username_is_empty = SignUpForm(data={
            'first_name': 'Garry',
            'last_name': 'Galler',
            'username': '',
            'password1': 'secretpassword',
